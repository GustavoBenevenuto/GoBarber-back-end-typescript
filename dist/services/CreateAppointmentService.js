...
var AppointmentsRopository_1 = __importDefault(require("../repositories/AppointmentsRopository"));
...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsRepository, appointmentDate, findAppointmnetInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentsRepository = typeorm_1.getCustomRepository(AppointmentsRopository_1.default);
                        appointmentDate = date_fns_1.startOfHour(date);
                        return [4 /*yield*/, appointmentsRepository.findByDate(appointmentDate)];
                    case 1:
                        findAppointmnetInSameDate = _b.sent();
                        // Se tiver datas iguais
                        if (findAppointmnetInSameDate) {
                            throw new AppError_1.default('This appointement is already booked');
                        }
